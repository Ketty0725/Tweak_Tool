...
2️⃣在MTerminal、NewTerm或其他第三方终端中输入"sudo tweaktool"命令运行(1.6.4及之前的版本为"sudo TweakTool")

由于Filza自带的终端效率偏低，建议使用方法2️⃣

### 注意⚠️
Xina用户请使用Saily版本控制或在<a href="https://github.com/Ketty0725/Tweak_Tool/releases">此处</a>下载1.6.4版本，Dopamine用户随意
